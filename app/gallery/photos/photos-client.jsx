...
const videoItems = [
  ...
  },
  {
    ...
    venue: "Drama",
    role: "Kumar Sumitt",
    iframeUrl: "https://www.youtube.com/embed/WqupanpPDiM?rel=0&modestbranding=1",
    youtubeId: "WqupanpPDiM",
  },
  {
    id: "video-4",
    type: "video",
    ...
    venue: "Drama",
    role: "Kumar Sumitt",
    iframeUrl: "https://www.youtube.com/embed/auO53iCgYK0?rel=0&modestbranding=1",
    youtubeId: "auO53iCgYK0",
  },
];

const ITEMS_PER_PAGE = 9;

export default function PhotosVideosPage({ galleryPhotos }) {
  ...
  const isModalOpen = Boolean(selectedImage || selectedVideo);
  ...
  return (
    ...
    >
      ...
      {/* Video Modal */}
      {selectedVideo && (
        <div className="fixed inset-0 bg-black z-[200] flex items-center justify-center p-4 md:p-8">
          <div className="relative w-full max-w-5xl mx-auto flex flex-col items-center justify-center pt-12">
            <button
              onClick={closeModal}
              className="absolute top-0 right-0 z-[210] bg-white/10 text-white p-3 rounded-full hover:bg-white/20 transition-colors shadow-xl border border-white/20"
            ...
            <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-2xl bg-black">
              <iframe
                src={`${selectedVideo.iframeUrl}&autoplay=1`}
                title={selectedVideo.title || "Kumar Sumitt Video"}
                className="absolute inset-0 w-full h-full"
                frameBorder="0"
            ...
            <div className="mt-4 text-center text-white px-4">
              ...
              <p className="text-sm text-gray-300 mt-1">{selectedVideo.role} · {selectedVideo.venue}</p>
            </div>
          </div>
        </div>
      )}
